# -*- coding: utf-8 -*-
"""
Created on Fri Jun  6 12:39:53 2025
...
def objetive(trial):
    ...
    red.add(GRU(num_units, activation = activation, input_shape = (time_step,X_op.shape[2])))
    #Capa de salida
...
plt.savefig(ruta_fig + "optimization_history_gru.pdf",  bbox_inches='tight')
...
plt.savefig(ruta_fig + "hip_param_impot_gru.pdf",  bbox_inches='tight')
...
plt.savefig(ruta_fig + "parallel_coordinate_gru.pdf", bbox_inches='tight')
plt.rcdefaults()
...
with open(ruta_fig + 'df_opti_gru.tex', 'w') as f:
