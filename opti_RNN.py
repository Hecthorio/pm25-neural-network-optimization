# -*- coding: utf-8 -*-
"""
Created on Thu Jun 12 12:23:09 2025
...
def objetive(trial):
    ...
    num_units = trial.suggest_int('num_units', 50, 300)  # Unidades de la capa RNN
    ...
    red.add(SimpleRNN(num_units, activation = activation, input_shape = (time_step,X_op.shape[2])))
    #Capa de salida
...
plt.savefig(ruta_fig + "optimization_history_rnn.pdf",  bbox_inches='tight')
...
plt.savefig(ruta_fig + "hip_param_impot_rnn.pdf",  bbox_inches='tight')
...
plt.savefig(ruta_fig + "parallel_coordinate_rnn.pdf", bbox_inches='tight')
plt.rcdefaults()
...
with open(ruta_fig + 'df_opti_rnn.tex', 'w') as f:
